    ...
    <div v-else>
        ...
        <template #header>
          <div class="card-header">
            ...
            <el-tag 
              ...
              effect="dark">
              {{ medicine.fda ? 'Updated Price' : 'NO Updated Price' }}
            </el-tag>
          </div>
        </template>
      ...
      <el-card class="detail-card" shadow="hover">
        ...
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="Technical Evaluation" span="1">
            <el-tag :type="medicine.details.technicalEvaluation ? 'success' : 'info'">
              {{ medicine.details.technicalEvaluation ? 'Required' : 'Not Required' }}
            </el-tag>
          </el-descriptions-item>
          
          <el-descriptions-item label="TTAC Required" span="1">
            <el-tag :type="medicine.details.ttacRequired ? 'success' : 'info'">
              {{ medicine.details.ttacRequired ? 'Required' : 'Not Required' }}
            </el-tag>
          </el-descriptions-item>
